...
// inviter v11 - unhappy path cancellations

router.post('/inviter/v11/support-verify', function (req, res) {
  ...
  if (supportEmail == "different"){
    // Send user to next page
    res.redirect('/inviter/v11/support-verify')
  } else {
    // Send user to ineligible page
    res.redirect('/inviter/v11/enter-details')
  }
